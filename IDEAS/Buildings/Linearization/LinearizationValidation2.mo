...
model LinearizationValidation2
...
simulateModel(&QUOT;IDEAS.Buildings.Linearization.LinearizationValidation(linCase900_1(roof(linearize=false)))&QUOT;, stopTime=1e+07, method=&QUOT;dassl&QUOT;, resultFile=&QUOT;LinearizationValidation&QUOT;);
