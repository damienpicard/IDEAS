within IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Borefield2.Interfaces;
...
public
  ...
  IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Borefield2.BaseClasses.GroundModel.BoreFieldWallTemperature
...
initial equation
  ...
  (kappaMat,rArr,nuMat,TSteSta) =
    IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Borefield2.BaseClasses.Scripts.saveAggregationMatrix(
    p_max=p_max,
    q_max=q_max,
    lenSim=lenSim,
    gen=bfData.gen,
