...
model internalHEXUTube
  ...
  InternalHEXUTube intHex(
    ...
    soi=IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Data.SoilData.WetSand_validation(),

    fil=IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Data.FillingData.Bentonite_validation(),

    gen=IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Data.ConfigurationData.SandBox_validation(),
