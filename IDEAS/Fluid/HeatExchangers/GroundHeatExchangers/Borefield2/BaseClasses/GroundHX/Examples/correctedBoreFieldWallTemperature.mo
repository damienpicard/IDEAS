within IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Borefield2.BaseClasses.GroundHX.Examples;
...
public
  IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Data.SoilData.SandStone soi
    "Soil parameters"
    annotation (Placement(transformation(extent={{-90,-92},{-70,-72}})));
  IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Data.FillingData.Bentonite
    fil "Filing parameters"
    annotation (Placement(transformation(extent={{-58,-92},{-38,-72}})));
  //Data.GeneralData.c8x1_h110_b5_d3600_T283
  IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Data.ConfigurationData.c1x1_h110_b5_d3600_T283
    gen annotation (Placement(transformation(extent={{-28,-92},{-8,-72}})));
algorithm
  t_old := t_new;
