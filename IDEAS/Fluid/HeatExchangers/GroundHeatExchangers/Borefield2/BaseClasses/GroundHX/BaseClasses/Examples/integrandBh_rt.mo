within IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Borefield2.BaseClasses.GroundHX.BaseClasses.Examples;
...
algorithm
  if time < 0.007 then
    ...
    int :=
      IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Borefield2.BaseClasses.GroundHX.BaseClasses.integrandBh_rt(
      r=0.055,
      D=100,
      u=time*lim);
  end if;
