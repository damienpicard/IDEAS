...
function saveAggregationMatrix
  ...
  input IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Data.Records.General
    gen "General charachteristic of the borefield";
  input
    IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Data.FillingData.Template
    fil "Thermal properties of the filling material";
...
************************************************************************************************************************ \n ");
  ...
  if not existShoTerRes or not Modelica.Utilities.Files.exist(pathSave + "Agg" +
    ...
    TWallSteSta :=
      IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Borefield2.BaseClasses.GroundModel.CorrectedBoreFieldWallTemperature(
      gen=gen,
      soi=soi,
      TResSho=TResSho[1, :],
      t_d=gen.tSteSta_d);
