...
model MultipleBoreholesWithHeatPump
  ...
  parameter
    IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Data.BorefieldData.SandStone_Bentonite_c8x1_h110_b5_d600_T283
    bfData annotation (Placement(transformation(extent={{74,74},{94,94}})));
  parameter Integer lenSim=3600*24*20 "length of the simulation";

  IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Borefield2.borefieldUTube
    multipleBoreholes(
    lenSim=lenSim,
    bfData=bfData,
