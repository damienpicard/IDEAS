within IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Borefield2.Examples.BaseClasses;
model MultipleBoreholesWithHeatPump
  ...
  Sensors.TemperatureTwoPort TSen_pri(
    ...
    T_start=bfData.steRes.T_ini) annotation (Placement(transformation(
        ...
        origin={46,-8})));
  parameter
    IDEAS.Fluid.HeatExchangers.GroundHeatExchangers.Data.BorefieldData.example_accurate
    bfData annotation (Placement(transformation(extent={{-90,-88},{-70,-68}})));
