...
initial algorithm
  ...
  assert(not zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.Custom
  ...
  if zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.UnixTimeStamp then
    timOff :=0;
  elseif zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.NY2010 or
    zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.Custom and yearRef == 2010 then
      timOff :=timeStampsNewYear[1];
  elseif zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.NY2011 or
    zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.Custom and yearRef == 2011 then
      timOff :=timeStampsNewYear[2];
  elseif zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.NY2012 or
    zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.Custom and yearRef == 2012 then
      timOff :=timeStampsNewYear[3];
  elseif zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.NY2013 or
    zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.Custom and yearRef == 2013 then
      timOff :=timeStampsNewYear[4];
  elseif zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.NY2014 or
    zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.Custom and yearRef == 2014 then
      timOff :=timeStampsNewYear[5];
  elseif zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.NY2015 or
    zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.Custom and yearRef == 2015 then
      timOff :=timeStampsNewYear[6];
  elseif zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.NY2016 or
    zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.Custom and yearRef == 2016 then
      timOff :=timeStampsNewYear[7];
  elseif zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.NY2017 or
    zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.Custom and yearRef == 2017 then
      timOff :=timeStampsNewYear[8];
  elseif zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.NY2018 or
    zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.Custom and yearRef == 2018 then
      timOff :=timeStampsNewYear[9];
  elseif zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.NY2019 or
    zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.Custom and yearRef == 2019 then
      timOff :=timeStampsNewYear[10];
  elseif zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.NY2020 or
    zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.Custom and yearRef == 2020 then
  ...
  if zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.Custom then
  ...
  assert(time + offset + timOff >= timeStampsNewYear[1],
   ...
   Therefore the simulation startTime must be at least " + String(timeStampsNewYear[1]) + "."
    elseif zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.Custom then
  ...
  assert(time + offset + timOff < timeStampsNewYear[size(timeStampsNewYear,1)],
    if zerTim == IDEAS.Utilities.Time2.Types.ZeroTime.Custom and yearRef >= lastYear then
      "Could not initialize date in the CalendarTime block.
   You selected a custom time=0 reference.
...
<code>zerTim==IDEAS.Utilities.Time2.Types.ZeroTime.Custom</code>,
